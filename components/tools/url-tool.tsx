      ...
      <div className="glass-subtle p-5">
        ...
        <div className="flex gap-3">
          <input
            ...
            className="min-w-0 flex-1 rounded-[8px] border border-[var(--hairline)] bg-[var(--surface)] px-4 py-2.5 text-[14px] text-[var(--text)] placeholder:text-[var(--text-secondary)] focus:outline-2 focus:outline-[var(--accent)]"
          />
          <button
            disabled
            className="shrink-0 cursor-not-allowed rounded-[8px] bg-[var(--accent)] px-5 py-2.5 text-[13px] font-semibold text-white opacity-50"
          >
            Shorten
          </button>
        </div>
