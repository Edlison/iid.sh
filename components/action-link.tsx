...
const baseClassName =
  "action-link inline-flex items-center justify-center gap-2 rounded-[8px] px-4 py-3 text-[14px] font-semibold no-underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]";

const variantClassNames: Record<ActionLinkVariant, string> = {
  primary:
    "action-link-primary bg-[var(--accent)] transition-[transform,background-color] hover:scale-[1.02] hover:bg-[var(--accent-hover)]",
  secondary:
